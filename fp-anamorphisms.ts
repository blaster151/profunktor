 ...
 *
 * - Build<T, Seed> builder coalgebra encoding
 * - Done/More constructors
 * - anaRecursive generic driver
 * - Unified ADT helpers for Maybe/Either/Result using local shapes
 *
...
// ---------------------------------------------
// Unified ADT helpers (local shapes)
// ---------------------------------------------
